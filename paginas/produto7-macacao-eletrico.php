...
$produto_id = 7;
$produto_nome = "Macaco Elétrico 2 Toneladas 12v 100w Controle Carro";
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-info-details">
                ...
                <div class="price-section">
                    ...
                    <p class="installments" id="installments-text">ou 12x de 37,17 sem juros</p>
                ...
                <form action="adicionar_carrinho.php" method="POST">
                    ...
                    <div class="sidebar-price-block">
                        ...
                        <div class="installments-display">
                            <span class="installment-amount" id="installment-amount-sidebar">12x de R$ 37,17</span>
