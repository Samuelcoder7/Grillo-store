...
const product = {
    ...
    slug: "produto-10-mangueira.php" // Slug adicionado para o checkout
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Função de redirecionamento para o checkout CORRIGIDA
    function goToCheckout() {
        // Usa replace em vez de href para não adicionar ao histórico
