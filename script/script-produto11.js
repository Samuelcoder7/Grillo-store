...
const product = {
    ...
    price: 46.99, // Valor à vista
    oldPrice: 0.00,
    // Valor a prazo (2x de R$ 27,64) -> Total: 55.28
    installments: { count: 2, value: 27.64, total: 55.28, isInterest: true }, // Adicionado isInterest
    color: "Preto",
    images: [
    ...
    specs: [
        ...
        "Conexão: USB e P3 (Não especificado, mas deduzido pelo título completo)"
    ],
    seller: "Grillo Store",
    slug: "produto-11-fone-de-ouvido.php" 
};
...
function displayProductDetails(product) {
    ...
    if (product.installments) {
        // Determina se há juros (baseado na nova propriedade isInterest ou se o total > preço à vista)
        ...
        document.getElementById('installment-details-sidebar').textContent = installmentType; // Indicando juros
    }
    ...
    if (mainImage && thumbnailGallery) {
        ...
        product.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.alt = `Miniatura do Headset ${index + 1}`;
