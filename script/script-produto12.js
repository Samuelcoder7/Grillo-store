// ARQUIVO: script-produto12.js
// ----------------------------------------------------
// LÓGICA DA PÁGINA DE PRODUTO INDIVIDUAL (APENAS EXIBIÇÃO E EVENTOS VISUAIS)

const product = {
    id: 12,
    name: "Caixa de Som Amplificada Portátil, Bluetooth, USB, Microfone, LED RGB",
    price: 179.90, // Valor à vista
    oldPrice: 0.00,
    // 5x de R$ 35,98 = R$ 179,90 (sem juros)
    installments: { count: 5, value: 35.98, total: 179.90, isInterest: false }, // Adicionado isInterest: false
    color: "Preto com LED RGB",
    images: [
        "../imagens-produtos/caixa1.jpg", 
        "../imagens-produtos/caixa2.jpg", 
        "../imagens-produtos/caixa3.jpg",
        "../imagens-produtos/caixa4.jpg",
        "../imagens-produtos/caixa5.jpg",
    ],
    specs: [
        "Conectividade: Bluetooth, USB, Cartão Micro SD, Auxiliar (P2)",
        "Áudio: Graves Excelentes, Potente e Portátil.",
        "Funcionalidade: MP3 Player, Rádio FM e Entrada para Microfone.",
        "Design: Luzes LED RGB e Alça de transporte.",
        "Compatibilidade: PCs, Notebooks, Smartphones, Tablets e Tvs."
    ],
    seller: "Grillo Store",
    slug: "produto-12-caixa-de-som.php"
};
...
function displayProductDetails(product) {
    ...
    if (product.installments) {
        // Determina se há juros (usando a nova propriedade isInterest ou comparando total e preço à vista)
        ...
        if (product.installments.total && hasInterest) {
    ...
    if (mainImage && thumbnailGallery) {
        ...
        product.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.alt = `Miniatura da Caixa de Som ${index + 1}`;
