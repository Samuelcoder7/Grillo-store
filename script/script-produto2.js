//
// LÓGICA DA PÁGINA DE PRODUTO INDIVIDUAL (Kit Camisetas Femininas)
//
const product = {
    id: 2,
    name: "Kit 4 Camisetas Feminina Academia - Atacado",
    price: 53.99,
    oldPrice: 0.00,
    installments: { count: 2, value: 29.99 },
    color: "Cores Variadas (Kit com 4)",
    images: [
        "../imagens-produtos/camisa1fem.jpg", 
        "../imagens-produtos/camisa3fem.jpg", 
        "../imagens-produtos/camisa5fem.jpg", 
        "../imagens-produtos/camisa4fem.jpg",
    ],
    specs: [
        "Marca: FORÇA DO SOL",
        "Material: Algodão (Conforto Máximo)",
        "Estilo da Peça: Básica (Ideal para Academia e Dia a Dia)",
        "Gola: Careca",
        "Tamanho: P"
    ],
    seller: "FORÇA DO SOL",
    // ⭐️ CORREÇÃO: Slug adicionado
    slug: "produto-2-camisetas-femininas.php"
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addToCartButton) {
        addToCartButton.addEventListener('click', () => {
            // Ação temporária (Carrinho Desativado)
            console.log(`Botão 'Adicionar ao Carrinho' clicado para o produto ID ${product.id}. A função de carrinho está desativada.`);
        });
    }
