...
const product = {
    ...
    // ⭐️ CORREÇÃO: Slug deve ser EXATAMENTE igual ao definido no script-checkout.js
    slug: "produto-9-kit-jardinagem.php"
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⭐️ CORREÇÃO: Redireciona para checkout com o produto específico
    if (checkoutPageButton) {
        checkoutPageButton.addEventListener('click', goToCheckout);
    }
    
    // ⭐️ CORREÇÃO: Redireciona para checkout com o produto específico (botão dentro do modal)
