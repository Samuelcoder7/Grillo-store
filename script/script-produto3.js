//
// LÓGICA DA PÁGINA DE PRODUTO INDIVIDUAL (Notebook Acer)
//
const product = {
    id: 3,
    name: "Notebook Acer Aspire Go Intel Core i5 13420H 8GB RAM 512GB SSD 15,6\" Full HD Windows 11",
    price: 2890.00,
    oldPrice: 0.00,
    installments: { count: 10, value: 321.11 },
    color: "Cinza (Arctic Gray)",
    images: [
        "../imagens-produtos/note1.jpg", 
        "../imagens-produtos/note2.jpg", 
        "../imagens-produtos/note3.jpg", 
        "../imagens-produtos/note4.jpg",
        "../imagens-produtos/note5.jpg" 
    ],
    specs: [
        ...
        "**Conexões:** 2 USB-C 3.2, 2 USB 3.2, 1 HDMI 2.1"
    ],
    seller: "Acer",
    // ⭐️ CORREÇÃO: Slug adicionado
    slug: "produto-3-notebook.php"
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addToCartButton) {
        addToCartButton.addEventListener('click', () => {
            // Lógica de notificação e feedback visual ativada
